 ...
 * https://github.com/GaryJones/Gamajo-Template-Loader/tree/develop
 */

if (!class_exists('Atomic_Base_Template_Loader')) {
	 ...
	 *
	 */
	class Atomic_Base_Template_Loader {
		/**
